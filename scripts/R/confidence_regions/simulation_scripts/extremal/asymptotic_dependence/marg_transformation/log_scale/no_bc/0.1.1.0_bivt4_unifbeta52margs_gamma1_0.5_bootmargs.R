...
# the AD margin-ladder simulations: BOUNDED, NON-DECAYING ENDPOINT: Uniform(0,1) and Beta(5,2), t_4 copula.
#
...
# NOTE: point save_full_path at wherever the 0.1.1.2 unifbeta52margs tubes were saved.
save_full_path <- '/pscratch/sd/j/jbbutler/isolines/simulations/extremal/0.1.1.2_bivt4_unifbeta52margs_gamma1_0.5_gamma2_0.67_bootmargs/'
...
if (length(results_list) > 0) {
    ...
    save_fname <- paste0(save_df_path, '0.1.1.0_bivt4_unifbeta52margs_gamma1_0.5_bootmargs.csv')

...
save_full_path <- '/pscratch/sd/j/jbbutler/isolines/simulations/extremal_logprobability_bias_correction/exp2.2.1/gamma1_0.5_gamma2_0.67/'
...
if (length(results_list) > 0) {
    ...
    save_fname <- paste0(save_df_path, 'extremal_coverage_exp2.2.1_ctrl.csv')

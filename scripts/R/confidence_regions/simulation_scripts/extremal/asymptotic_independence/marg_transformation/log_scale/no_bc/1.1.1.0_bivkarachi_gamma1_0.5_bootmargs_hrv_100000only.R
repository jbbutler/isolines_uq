# 1.1.1.0 raw-walls AI tubes (bivkarachi, n = 100000 ONLY): pure-HRV radial
...
for (i in 1:length(dists)) {
    ...
    for (k in 1:length(ns)) {
        ...
        if (!is.null(args$save_df_path)) {
            ...
            save_fname <- paste0(args$save_df_path, '1.1.1.0_bivkarachi_gamma1_0.5_bootmargs_hrv_n100000.csv')

...
# t4t10margs bootmargs_cooleysmoothpercoord): per-coordinate (Cooley)
...
# true isoline (t_4 / t_10 margins, Gaussian copula rho = 0.7).
...
# NOTE: point save_full_path at wherever the 1.1.1.2 t4t10margs tubes were saved.
save_full_path <- '/pscratch/sd/j/jbbutler/isolines/simulations/extremal/1.1.1.2_bivgausscopula_t4t10margs_gamma1_0.5_gamma2_0.67_bootmargs_cooleysmoothpercoord/'
...
# ======================================================================
results_list <- list()
print("Evaluating RAW single tube: gausscopula t4t10margs percoord...")
...
if (length(results_list) > 0) {
    ...
    save_fname <- paste0(save_df_path, '1.1.1.0_bivgausscopula_t4t10margs_gamma1_0.5_bootmargs_cooleysmoothpercoord.csv')

...
#runs[[1]] <- c(5000, 1000, 0.05, 2, 2.61, 2)
#runs[[2]] <- c(5000, 1000, 0.05, 2, 1.50, 1)
runs[[1]] <- c(5000, 1000, 0.05, 2, 0, 2)
#runs[[6]] <- c(5000, 1000, 0.05, 2, 1.50, 1)
#runs[[7]] <- c(5000, 1000, 0.05, 2, 2.61, 2)
...
parallelizedCode <- function(ind, n, n_boot) {
    ...
    dat <- readRDS(paste0(path, n, 'sims/', n_boot, 'boot/', ind, '_', n,'bigger_bivgauss_bootstrap.RData'))
...
saveRDS(confints, file = paste0('/global/homes/j/jbbutler/isolines_uq/results/', prefix, '_bivgauss_confints.RData'))
}
